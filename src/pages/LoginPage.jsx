        ...
        <>
            <div className='grid place-items-center mt-[10rem]'>
                <div className='flex flex-col justify-center items-center border rounded-sm py-[2rem] min-w-[25rem]'>
                    ...
                    <Button type='submit' className='mt-[.5rem] font-[500]'>{isLogin ? 'Log in' : 'Sign up'}</Button>
                    ...
                    <div className='flex gap-[.5rem] justify-center items-center cursor-pointer' onClick={() => console.log('clicked')}>
                        <img src={googleLogo} className='h-5 w-5' alt="Google Logo" />
                        <span className='text-slate-200 text-sm'>Log in with Google</span>
                    </div>
                </div>
                <div className='flex justify-center items-center border rounded-sm mt-[1rem] py-[1rem] min-w-[25rem]'
                    onClick={() => setIsLogin(prevState => !prevState)}
                >
                    <span className='text-sm text-slate-200 cursor-pointer'>Don't have an account? {isLogin ? "Sign up" : "Log in"}</span>
                </div>
                <div className='py-[1rem]'>
                    <span className='text-sm text-slate-200'>Get the app.</span>
                </div>
